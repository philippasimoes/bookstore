...
public class BookRepositoryTest {
  ...
  @Autowired public BookRepository bookRepository;

  @Autowired public AuthorRepository authorRepository;

  @Autowired public LanguageRepository languageRepository;
  ...
  public void testAllBooksFromAuthor() {
    ...
    List<Book> books =
        bookRepository.findAll(
            Specification.where(BookSpecifications.allBooksFromAuthor(savedAuthor)));
  ...
  public void testHasPredicate() {
    ...
    List<Book> books =
        bookRepository.findAll(
            Specification.where(BookSpecifications.hasValue("genre", "Adventure")));
