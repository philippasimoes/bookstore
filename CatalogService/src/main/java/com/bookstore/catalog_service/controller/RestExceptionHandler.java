...
public class RestExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleInputNotAcceptedException() {
        ...
        ApiError error = new ApiError(HttpStatus.NOT_ACCEPTABLE.value(), "The start price should bw lower than the end price", new Date(System.currentTimeMillis()));
    ...
    public ResponseEntity<ApiError> handleDuplicatedResourceException() {
        ...
        ApiError error = new ApiError(HttpStatus.FOUND.value(), "Book with entered ISBN already exists", new Date(System.currentTimeMillis()));
